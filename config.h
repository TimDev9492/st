...
static const char *colorname[] = {
    ...
    "#cccccc", /* cursor color [256] */
    "white",   /* selected cursor color [257] */
    "gray90",  /* default foreground colour [258] */
    "#0f0e0f", /* default background colour [259] */
};
...
static MouseShortcut mshortcuts[] = {
    ...
    { ShiftMask,            Button4, ttysend,        {.s = "\033[5;2~"},    0,      -1},
    { XK_ANY_MOD,           Button4, ttysend,        {.s = "\031"}},
    { ShiftMask,            Button5, ttysend,        {.s = "\033[6;2~"},    0,      -1},
